...
Multiple_proteomes_smallFC_SN_report_V11 <- read_delim("MP-SFC-OT-SN-Report.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
# make column Run
data <- Multiple_proteomes_smallFC_SN_report_V11 %>% 
...
write.csv(info, 'MP-SFC-OT-annotation.csv')
