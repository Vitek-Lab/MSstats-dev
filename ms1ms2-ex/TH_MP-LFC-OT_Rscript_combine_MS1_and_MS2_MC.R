...
Multiple_proteomes_largeFC_SN_report_V11 <- read_delim("MP-LFC-OT-SN-Report.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
# make column Run
data <- Multiple_proteomes_largeFC_SN_report_V11 %>% 
...
write.csv(info, 'MP-LFC-OT-annotation.csv')
